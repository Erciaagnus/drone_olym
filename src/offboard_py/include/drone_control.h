...
class DroneControl
{
    public:
        ...
        static constexpr float INIT_FLIGHT_DURATION=4.0;
        static constexpr float INIT_FLIGTH_LENGTH=4.0; // In seconds per side
        static constexpr float INIT_FLIGTH_REPEAT=5;
        static constexpr float TEST_FLIGHT_LENGTH=2.0;
        static constexpr float TEST_FLIGTH_DURATION=3.0;
        static constexpr int TEST_FLIGHT_REPEAT=2;
        ...
        void extended_state_cb(const mavros_msgs::ExtendState::ConstPtr &msg);
